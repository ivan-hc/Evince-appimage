...
rm -R -f ./*.desktop
LAUNCHER=$(grep -iRl $BIN ./.junest/usr/share/applications/* | grep ".desktop" | grep -v preview | head -1)
cp -r "$LAUNCHER" ./
...
LIBSAVED="evince" # Enter here keywords or file/folder names to save in /usr/lib
